-- About --
An example Python client for the Chatterbox Analytics Sentiment Detection API delivered through the Mashape platform.  The API is designed specifically for short social texts.
...
The mashape folder contains the Mashape API code.  At the time of writing this was current (December 2012), although you should check for a new version.

-- Output --
The script prints results to the terminal

-- Contact --
api@cbanalytics.co.uk
